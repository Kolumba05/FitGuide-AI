...
Скачайте ZIP файл и распакуйте, свяжитесь со мной для отправки вам .env файла с токеном, запустите app.py через VS Code
Введите команду - streamlit run app.py
